...
//                synchronized (object) {
//                    object.notify();
//                    System.out.println("notify成功");
//                    try {
//                        object.wait();
//                        System.out.println("wait成功");
//                    } catch (InterruptedException e) {
...
//                        e.printStackTrace();
//                    }
//                    System.out.println("pre:interrupt状态:" + t1.isInterrupted());
//                    t1.interrupt();
//                    System.out.println("interrupt成功");
//                    System.out.println("after:interrupt状态:" + t1.isInterrupted());
//                }
//                try {
//                    Thread.sleep(3000);
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//                System.out.println("end:interrupt状态:" + t1.isInterrupted());
//            }
//        });
//        t2.start();
//    }
